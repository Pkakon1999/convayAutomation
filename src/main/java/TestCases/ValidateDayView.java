...
import Page_Objects.ValidateDayView_Page;
import Utilities.Take_Screenshot;

public class ValidateDayView {
	...
	@Test(priority = 1) // Test case to validate Convay meeting calender (Day View)
	void DayView() throws InterruptedException {
		// Navigate to the invitation card after login
		ValidateDayView_Page day = new ValidateDayView_Page(driver);
		...
		// To validate Day button text
		String expectedTextDay = "DayWeekMonth";
		day.validateDayButtonText(expectedTextDay);
		Thread.sleep(2000);

...
import Page_Objects.StartInstantMeeting_Page;
import Utilities.Take_Screenshot;

public class StartInstantMeeting {
	...
	void Instant_Meeting_Cancel() throws InterruptedException {
		// Navigate to the Start meeting option after login
		StartInstantMeeting_Page instant = new StartInstantMeeting_Page(driver);
	...
	@Test(priority = 2) // Test case to start an instant meeting
	void Instant_Meeting() throws InterruptedException {
		// Navigate to the Start meeting option after login
		StartInstantMeeting_Page instant = new StartInstantMeeting_Page(driver);

...
import Page_Objects.AccessTranscription_Page;
import Utilities.Take_Screenshot;

public class AccessTranscription {
	...
	@Test(priority = 1) // Test case to access Transcription
	void Transcription() throws InterruptedException {
		// Navigate to the Start meeting option after login
		AccessTranscription_Page accessTranscription = new AccessTranscription_Page(driver);

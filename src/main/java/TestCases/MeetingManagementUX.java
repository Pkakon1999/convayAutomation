...
import Page_Objects.MeetingManagementUX_Page;
import Utilities.Take_Screenshot;

public class MeetingManagementUX {
	...
	@Test(priority = 1) // Test case to validate UX of upcoming meeting management
	void upcomingUX() throws InterruptedException {
		// Navigate to the Start meeting option after login
		MeetingManagementUX_Page meetingManagementUX = new MeetingManagementUX_Page(driver);

		// Click on meeting management
		meetingManagementUX.clickMeetingManagement();
		Thread.sleep(5000);

		// Click on upcoming meeting
		meetingManagementUX.clickUpcomingMeeting();
		Thread.sleep(5000);

		// To validate "Upcoming Meetings" button text
		String expectedText = "Upcoming Meetings";
		meetingManagementUX.validateUpcomingButtonText(expectedText);
		Thread.sleep(2000);
	...
	@Test(priority = 2) // Test case to validate UX of previous meeting management
	void previousUX() throws InterruptedException {
		// Navigate to the Start meeting option after login
		MeetingManagementUX_Page meetingManagementUX = new MeetingManagementUX_Page(driver);
		...
		// Click on upcoming meeting
		meetingManagementUX.clickPreviousMeeting();
		Thread.sleep(5000);

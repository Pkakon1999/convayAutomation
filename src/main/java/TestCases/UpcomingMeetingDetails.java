...
import Page_Objects.UpcomingMeetingDetails_Page;
import Utilities.Take_Screenshot;

public class UpcomingMeetingDetails {
	...
	@Test(priority = 1) // Test case to validate host name of upcoming meeting
	void UpcomingDetailsHost() throws InterruptedException {
		// Navigate to the Start meeting option after login
		UpcomingMeetingDetails_Page upcoming = new UpcomingMeetingDetails_Page(driver);

		// Click on meeting management
		upcoming.clickMeetingManagement();
		Thread.sleep(4000);

		// Click on Upcoming Meetings
		upcoming.clickUpcomingMeetings();
		Thread.sleep(2000);

		// Capture the meeting Host name of the upcoming meeting
		String initialValue = upcoming.getHost();

		// Assert the upcoming meeting ID
		String afterGetHost = upcoming.getHost();
	...
	@Test(priority = 2) // Test case to get ID of upcoming meeting
	void UpcomingDetailsID() throws InterruptedException {
		// Navigate to the Start meeting option after login
		UpcomingMeetingDetails_Page upcoming = new UpcomingMeetingDetails_Page(driver);
		...
		// Capture the meeting ID of the upcoming meeting
		String initialValue = upcoming.getID();

		// Assert the upcoming meeting ID
		String afterGetID = upcoming.getID();
	...
	@Test(priority = 3) // Test case to get URL of upcoming meeting
	void UpcomingDetailsURL() throws InterruptedException {
		// Navigate to the Start meeting option after login
		UpcomingMeetingDetails_Page upcoming = new UpcomingMeetingDetails_Page(driver);
		...
		// Capture the meeting URL of the upcoming meeting
		String initialValue = upcoming.getURL();

		// Assert the upcoming meeting ID
		String afterGetURL = upcoming.getURL();

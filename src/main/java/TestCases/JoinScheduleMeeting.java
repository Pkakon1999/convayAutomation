...
import Page_Objects.JoinScheduleMeeting_Page;
import Utilities.Take_Screenshot;

public class JoinScheduleMeeting {
	...
	@Test(priority = 1) // Test case to cancel a schedule meeting
	void Schedule_Meeting_Join_Cancel() throws InterruptedException {
		// Navigate to the Start meeting option after login
		JoinScheduleMeeting_Page join = new JoinScheduleMeeting_Page(driver);

		// Click on meeting management
		join.clickMeetingManagement();
		Thread.sleep(5000);

		// Click on start schedule meeting
		join.clickJoinSchedule();
		Thread.sleep(2000);
	...
	@Test(priority = 2) // Test case to join in a schedule meeting
	void Schedule_Meeting_Join() throws InterruptedException {
		// Navigate to the Start meeting option after login
		JoinScheduleMeeting_Page join = new JoinScheduleMeeting_Page(driver);

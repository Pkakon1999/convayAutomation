...
import Page_Objects.UpcomingMeetingJoin_Page;
import Utilities.Take_Screenshot;

public class UpcomingMeetingJoin {
	...
	void Upcoming_Meeting_Cancel() throws InterruptedException {
		...
		UpcomingMeetingJoin_Page upcomingJoin = new UpcomingMeetingJoin_Page(driver);

		// Click on join in an upcoming meeting
		upcomingJoin.clickJoinUpcoming();
		Thread.sleep(2000);

		// Click on "Cross" button
		upcomingJoin.clickCross();
		Thread.sleep(2000);
	...
	@Test(priority = 2) // Test case to join in an upcoming meeting
	void Upcoming_Meeting_Join() throws InterruptedException {
		// Navigate to the Start meeting option after login
		UpcomingMeetingJoin_Page upcomingJoin = new UpcomingMeetingJoin_Page(driver);

		// Click on join upcoming meeting
		upcomingJoin.clickJoinUpcoming();
		Thread.sleep(2000);

		// Click on "Continue" button
		upcomingJoin.clickStart();
		Thread.sleep(10000);

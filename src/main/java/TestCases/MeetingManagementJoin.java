...
import Page_Objects.MeetingManagementJoin_Page;
import Utilities.Take_Screenshot;

public class MeetingManagementJoin {
	...
	void Upcoming_Meeting_Cancel() throws InterruptedException {
		...
		MeetingManagementJoin_Page upcomingJoin = new MeetingManagementJoin_Page(driver);

		// Click on meeting management
		upcomingJoin.clickMeetingManagement();
		Thread.sleep(5000);

		// Click on start schedule meeting
		upcomingJoin.clickJoinSchedule();
		Thread.sleep(2000);

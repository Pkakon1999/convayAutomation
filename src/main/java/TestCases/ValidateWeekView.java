...
import Page_Objects.ValidateWeekView_Page;
import Utilities.Take_Screenshot;

public class ValidateWeekView {
	...
	@Test(priority = 1) // Test case to validate Convay meeting calender (Week View)
	void WeekView() throws InterruptedException {
		// Navigate to the invitation card after login
		ValidateWeekView_Page week = new ValidateWeekView_Page(driver);
		...
		// To validate Week button text
		String expectedTextWeek = "Week";
		week.validateWeekButtonText(expectedTextWeek);
		Thread.sleep(2000);

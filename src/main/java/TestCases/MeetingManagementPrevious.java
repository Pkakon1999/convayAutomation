...
import Page_Objects.MeetingManagementPrevious_Page;
import Utilities.Take_Screenshot;

public class MeetingManagementPrevious {
	...
	@Test(priority = 1) // Test case to access previous meeting field
	void UpcomingUX1() throws InterruptedException {
		// Navigate to the Start meeting option after login
		MeetingManagementPrevious_Page previous = new MeetingManagementPrevious_Page(driver);
		...
		// Capture the previous meeting button text
		String initialValue = previous.getButtonText();

		// Assert the previous meeting button text
		String afterGetPreviousField = previous.getButtonText();
		Assert.assertEquals(afterGetPreviousField, initialValue, "Previous Meetings");
	}

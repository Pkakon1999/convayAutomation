...
import Page_Objects.MeetingManagementUpcoming_Page;
import Utilities.Take_Screenshot;

public class MeetingManagementUpcoming {
	...
	@Test(priority = 1) // Test case to access upcoming meeting field
	void UpcomingUX1() throws InterruptedException {
		// Navigate to the Start meeting option after login
		MeetingManagementUpcoming_Page upcoming = new MeetingManagementUpcoming_Page(driver);
		...
		// Capture the upcoming meeting button text
		String initialValue = upcoming.getButtonText();

		// Assert the upcoming meeting button text
		String afterGetUpcomingField = upcoming.getButtonText();

...
public class AdvanceOptions_Page {
	...
	By advanceOptions_loc = By.xpath("//a[normalize-space()='Advance Options']");

	// Constructor
	public AdvanceOptions_Page(WebDriver driver) {
		this.driver = driver;

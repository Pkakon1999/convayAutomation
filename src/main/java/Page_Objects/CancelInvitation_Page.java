...
public class CancelInvitation_Page {
	...
	By btn_threeDot = By.xpath("/html[1]/body[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[7]/div[1]/span[1]/span[1]");
	By btn_CancelInvitation_loc = By.xpath("//a[normalize-space()='Cancel Invitation']");
	By btn_No = By.xpath("//button[normalize-space()='No']");
	By btn_Yes = By.xpath("//button[normalize-space()='Yes']");
	By toaster_Message = By.xpath("//div[@class='cnv-toast-body']");
	

	// Constructor
	public CancelInvitation_Page(WebDriver driver) {
		this.driver = driver;
	...
	// Method to select cancel invitation
	public void selectCancel() {
		driver.findElement(btn_CancelInvitation_loc).click();
	}

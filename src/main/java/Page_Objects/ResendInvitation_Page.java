...
public class ResendInvitation_Page {
	...
	By btn_ResendInvitation_loc = By.xpath("//a[normalize-space()='Resend Invitation']");
	...
	// Constructor
	public ResendInvitation_Page(WebDriver driver) {
		this.driver = driver;
	...
	// Method to select resend invitation
	public void selectResend() {
		driver.findElement(btn_ResendInvitation_loc).click();
	}
